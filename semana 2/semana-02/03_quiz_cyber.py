...
# 5 perguntas sobre segurança da informação com placar, timer e loop automático
...
def rodar_quiz():
    pontos = 0
    rodada = random.sample(perguntas, len(perguntas))

    for i, q in enumerate(rodada, start=1):
